...
describe('Part Search by Keyword Search type - Result grid ', () => {
    ...
    beforeEach(async () => {
        ...
        await partsSearchLogic.checkKeywordRadioButton();
        await partsSearchLogic.performPartsSearch(commonSearch.validKeywordValue);
    });
