...
describe('Haystack Search -  Results Page', () => {
    ...
    it('should be View Search Criteria for Part Number and Vendor fields - Haystack Search',  async () => {
        await searchLogic.refineLinkChecking();
        await haystackSearchLogic.viewSearchCriteriaPartNumberWithVendor();
    });

    it('should be View Search Criteria for Vendor field - Haystack Search',  async () => {
        await searchLogic.refineLinkChecking();
