...
describe('Knowledge Base - Manufactures Knowledge Base - User Name/ Column filters', () => {
    ...
    it('should filter with ' + columnHeaders.bom.filterOptions[0] + ' option', async () => {
        const values: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
        ...
        await grid.newGridCheckFilterIconPresentInColumnHeaderByColumnName(1, 'User Name',
            true);
        const afterSortValues: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
    ...
    it('should filter with ' + columnHeaders.bom.filterOptions[2] + ' option', async () => {
        await grid.newGridCheckFilterIconPresentInColumnHeaderByColumnName(1, 'User Name',
            true);
        const psNameValues: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
        await grid.newGridOpenFilterBoxByName('User Name');
        ...
        await grid.newGridCheckFilterIconPresentInColumnHeaderByColumnName(1, 'User Name',
            true);
        const psValuesAfterSorting: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
    ...
    it('should filter with ' + columnHeaders.bom.filterOptions[1] + ' option', async () => {
        ...
        await grid.newGridCheckFilterIconPresentInColumnHeaderByColumnName(1, 'User Name',
            true);
        const bomNameValuesAfterSorting: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
...
describe('Knowledge Base - Manufactures Knowledge Base - User Name/ Column sorting', () => {
    ...
    it('should be ASC sorting', async () => {
        ...
        await grid.newGridCheckSortingIconPresentInColumnHeaderByColumnName('ASC', 1,
            'User Name', true);
        const activeNameActualAscValues: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
    ...
    it('should be DESC sorting', async () => {
        ...
        await grid.newGridCheckSortingIconPresentInColumnHeaderByColumnName('DESC', 1,
            'User Name', true);
        const activeNameActualDescValues: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
    ...
    it('should be Clear sorting', async () => {
        await grid.newGridOpenFilterBoxByName('User Name');
        await grid.selectOptionInColumnFilter(columnHeaders.commonColumnSortOptions.ascSort, gridElements.newGridRows.get(0));
        const activeNameAscValues: string[] = await grid.getCellValuesByCellId(columnIdByColumnName.mfrsKnowledgeBaseColumnNamesContent['User Name']);
        await grid.newGridOpenFilterBoxByName('User Name');
        await grid.selectOptionInColumnFilter(columnHeaders.commonColumnSortOptions.clearSort, gridElements.newGridRows.get(0));
        await grid.newGridCheckSortingIconPresentInColumnHeaderByColumnName('ASC', 1,
            'User Name', false);
