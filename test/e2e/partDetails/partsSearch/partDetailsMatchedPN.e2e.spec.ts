...
describe('Part Details modal with links from Parts Search grid  - Matched Part Number', () => {
    ...
    it('should be basic section in the left nav - Matched Part Number Parts Search ', async () => {
        await partDetailsLogic.checkBasicSection()
    });

    it('should be Life Cycle section in the left nav - Matched Part Number Parts Search ', async () => {
        await partDetailsLogic.checkLifeCycleSection()
    });

    it('should be Compliance section in the left nav - Matched Part Number Parts Search ', async () => {
    ...
    it('should be add button with dropdown list  - Matched Part Number - Parts Search',  async () => {
        await partDetailsLogic.addDropdown();
    });

    it('should open Add to BOM(s) modal  - Matched Part Number - Parts Search',  async () => {
