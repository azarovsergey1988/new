...
describe('Part Details - Documents - BOM Details', () => {
    ...
    it('should be tooltip for the Documents icon - BOM Details', async () => {
        await partDetailsLogic.iconTooltip(partDetailsElements.docIcon,partDetailsData.tooltips.documents);
    });

    it('should open part details modal by clicking on the Documents icon - BOM Details', async () => {
        await modal.openModalWithElement(partDetailsElements.docIcon.first());
    });

    it('should be column headers for documents - BOM Details',  async () => {
    ...
    it('should be links in Document Title column - BOM Details',  async () => {
        await partDetailsLogic.linksChecking();
    });

    it('should be sorting for Document Type column headers - documents - BOM Details',  async () => {
    ...
    it(" should be export dropdown - Documents - BOM Details", async () => {
        await partDetailsLogic.exportDropdown();
    });

    it('should be add button with dropdown list  - Documents - BOM Details',  async () => {
        await partDetailsLogic.addDropdown();
    });

    it('should open Add to BOM(s) modal  - Documents - BOM Details ',  async () => {
        await partDetailsLogic.addToBomModal();
    });

    it('should open view alternates modal  - Documents - BOM Details',  async () => {
    ...
    it('should open  print preview all modal - Documents -  BOM Details', async () => {
        await partDetailsLogic.printModal();
    });

    it('should open specific print preview modals - Documents - BOM Details', async () => {
