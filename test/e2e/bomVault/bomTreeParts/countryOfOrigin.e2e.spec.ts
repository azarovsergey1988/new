...
describe('Country Of Origin - BOM Tree Parts', () => {
    ...
    it('should open BOM having Country of origin details and verify country Name', async () => {
        ...
        await bomTreePartsLogic.openBomByName('Automation_COO');
    ...
    it('should be Enter Part Number in filter box having multiple Country of origin details and verify country Name', async () => {
        await grid.newGridOpenFilterBoxByNamebomtreeparts('Matched P/N');
