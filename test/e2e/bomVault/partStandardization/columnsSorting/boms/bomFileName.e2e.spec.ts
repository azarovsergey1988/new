...
describe('Part Standardisation - BOMs Tab - BOM File Name column', () => {
    ...
    it('should work Reset columns', async () => {
        ...
        await await grid.newGridOpenFilterBoxByName('BOM File Name');
    ...
    it('should be option Hide and Unhide column', async () => {
        ...
        await toolbar.unhideCellNameWithUnhideAllByNumber('BOM File Name',1);
    });
});
