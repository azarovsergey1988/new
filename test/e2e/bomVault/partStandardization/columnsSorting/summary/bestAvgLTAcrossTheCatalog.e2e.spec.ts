...
describe('Part Standardisation - Summary Tab - Best Avg LT column sort', ()=> {
    beforeAll(async() => {
        ...
        await partStandardizationLogic.createNewReprocessedView('BestAvgLTCatalog', 6);
    });
    ...
    afterAll(async() =>{
        ...
        await meganav.goToFeatureWithMeganavSubLinks(meganavItems.boms,
            meganavItems.bomsSubItems.partStandardization, gridElements.gridWrapper);
        await partStandardizationLogic.deleteViewByName('BestAvgLTCatalog');
    });
    ...
    beforeEach(async() => {
        ...
        await grid.mechanismCheckCheckboxByName('Name', 'BestAvgLTCatalog');
