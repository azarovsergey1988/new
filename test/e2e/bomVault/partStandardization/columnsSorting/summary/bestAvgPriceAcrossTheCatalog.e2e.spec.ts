...
describe('Part Standardisation - Summary Tab - Best Avg Price column sort', ()=> {
    beforeAll(async() => {
        ...
        await partStandardizationLogic.createNewReprocessedView('BestAvgPriceCatalog', 6);
    });
    ...
    afterAll(async() =>{
        ...
        await meganav.goToFeatureWithMeganavSubLinks(meganavItems.boms,
            meganavItems.bomsSubItems.partStandardization, gridElements.gridWrapper);
        await partStandardizationLogic.deleteViewByName('BestAvgPriceCatalog');
    });
    ...
    beforeEach(async() => {
        ...
        await grid.mechanismCheckCheckboxByName('Name', 'BestAvgPriceCatalog');
