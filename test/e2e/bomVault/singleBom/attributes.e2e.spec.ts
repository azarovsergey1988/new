...
describe('BOM Attributes', () => {
    ...
    xit('should be active save changes/reset button when edit Match All Manufacturer Parts' ,  async () => {
        await attributesLogic.checkingSaveChangesButton(1);
    });

    xit('should open reporcess modal when edit Match All Manufacturer Parts' ,  async () => {
        await attributesLogic.reprocessChecking();
    });
