...
describe('View Single BOM /Match Parts tab - Life Cycle Stage/ Column sorting', () => {
    ...
    it('should be sort options', async () => {
        await grid.newGridOpenFilterBoxByName('Life Cycle Stage');
    ...
    it('should be option Hide and Unhide column', async () => {
        await grid.newGridHideColumnByName('Life Cycle Stage');
        await toolbar.unhideCellNameWithCellValue('Life Cycle Stage');
        await expect(await gridElements.newGridHeaderByName('Life Cycle Stage').isDisplayed()).toBeTruthy();
    });
    ...
    it('should work Reset columns', async () => {
        ...
        await grid.newGridHideColumnsRange([ 'Imported Part Number', 'Matched Part Number','Imported Manufacturer Name', 'Matched Manufacturer Name','Imported Part Description', 'Internal Part Number'])
        const colNumber: number = await grid.newGridReturnColumnNumberByColumnName(1, 'Life Cycle Stage');
